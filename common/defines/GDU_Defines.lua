...
---------------------------	
NDefines.NGame.GAME_SPEED_SECONDS = { 2.0, 0.5, 0.15, 0.03, 0.0 }	
...
NDefines.NMilitary.LAND_COMBAT_STR_DAMAGE_MODIFIER = 0.074
NDefines.NMilitary.LAND_COMBAT_ORG_DAMAGE_MODIFIER = 0.033
...
NDefines.NAir.NAVAL_STRIKE_DAMAGE_TO_ORG = 2.0					-- Balancing value to convert damage ( naval_strike_attack * hits ) to Organisation reduction.
